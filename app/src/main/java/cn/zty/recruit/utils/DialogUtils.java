...
public class DialogUtils {
    ...
    private static final String AREA_SELECT = "areaSelectFragment";
    private static final String SCHOOL_SELECT = "schoolSelectFragment";
    private static final String MAJOR_SELECT = "majorSelectFragment";
