...
public class UpdateUserPresenter extends IBasePresenter<UserView> {
    ...
    private Observable<ResultBean<UserModel>> submit(String fullNm, String sex,
    ...
    public void update(@Nullable String fullNm, @Nullable String sex,
        ...
        mSubscription = RxManager.getInstance().doSubscribe1(submit(fullNm, sex, mobile, birthDate, education, province, city, photo), new RxSubscriber<UserModel>() {
            @Override
